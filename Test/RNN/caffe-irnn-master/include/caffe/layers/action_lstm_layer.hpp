#ifndef CAFFE_ACTION_LSTM_LAYER_HPP_
#define CAFFE_ACTION_LSTM_LAYER_HPP_
...
namespace caffe {
  ...
  class ActionLstmLayer : public Layer<Dtype> {
   public:
    explicit ActionLstmLayer(const LayerParameter& param)
        : Layer<Dtype>(param) {}
    ...
    virtual inline const char* type() const { return "ActionLstm"; }
...
#endif  // CAFFE_ACTION_LSTM_LAYER_HPP_
